...
declare global {
  ...
  const hasPerm: typeof import('../src/directives/has-perm')['default']
  const hasRole: typeof import('../src/directives/has-role')['default']
  ...
  const useDict: typeof import('../src/hooks/use-dict.js')['useDict']
