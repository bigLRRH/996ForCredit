<template>
  <div class="login-container columnCC">
    ...
    <div class="el-login-footer">
      <span>Copyright © 2023-{{ new Date().getFullYear() }} Lu All Rights Reserved.</span>
    </div>
  </div>
</template>
...
import { LoginForm, getCodeImg, loginReq } from '@/api/login.ts'
